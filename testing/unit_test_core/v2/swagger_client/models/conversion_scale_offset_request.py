...
class ConversionScaleOffsetRequest(object):
    """
    ...
    def __init__(self, from_unit_persistable_reference=None, to_unit_persistable_reference=None, from_unit=None, to_unit=None):
        """
        ConversionScaleOffsetRequest - a model defined in Swagger
        """
    ...
    def from_unit_persistable_reference(self):
        """
        Gets the from_unit_persistable_reference of this ConversionScaleOffsetRequest.
        ...
        :return: The from_unit_persistable_reference of this ConversionScaleOffsetRequest.
        :rtype: str
        """
    ...
    def from_unit_persistable_reference(self, from_unit_persistable_reference):
        """
        Sets the from_unit_persistable_reference of this ConversionScaleOffsetRequest.
        The persistable reference string (JSON serialized Unit 'essence') representing toe 'from Unit'. Either 'fromUnitPersistableReference' or 'fromUnit' must be populated.

        :param from_unit_persistable_reference: The from_unit_persistable_reference of this ConversionScaleOffsetRequest.
        :type: str
        """
    ...
    def to_unit_persistable_reference(self):
        """
        Gets the to_unit_persistable_reference of this ConversionScaleOffsetRequest.
        ...
        :return: The to_unit_persistable_reference of this ConversionScaleOffsetRequest.
        :rtype: str
        """
    ...
    def to_unit_persistable_reference(self, to_unit_persistable_reference):
        """
        Sets the to_unit_persistable_reference of this ConversionScaleOffsetRequest.
        The persistable reference string (JSON serialized Unit 'essence') representing toe 'to Unit'. Either 'toUnitPersistableReference' or 'toUnit' must be populated.

        :param to_unit_persistable_reference: The to_unit_persistable_reference of this ConversionScaleOffsetRequest.
        :type: str
        """
    ...
    def from_unit(self):
        """
        Gets the from_unit of this ConversionScaleOffsetRequest.
        The source or 'from' unit essence

        :return: The from_unit of this ConversionScaleOffsetRequest.
        :rtype: UnitEssence
        """
    ...
    def from_unit(self, from_unit):
        """
        Sets the from_unit of this ConversionScaleOffsetRequest.
        The source or 'from' unit essence

        :param from_unit: The from_unit of this ConversionScaleOffsetRequest.
        :type: UnitEssence
        """
    ...
    def to_unit(self):
        """
        Gets the to_unit of this ConversionScaleOffsetRequest.
        The target or 'to' unit essence

        :return: The to_unit of this ConversionScaleOffsetRequest.
        :rtype: UnitEssence
        """
    ...
    def to_unit(self, to_unit):
        """
        Sets the to_unit of this ConversionScaleOffsetRequest.
        The target or 'to' unit essence

        :param to_unit: The to_unit of this ConversionScaleOffsetRequest.
        :type: UnitEssence
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ConversionScaleOffsetRequest):
            return False
