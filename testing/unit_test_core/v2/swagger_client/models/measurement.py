...
class Measurement(object):
    ...
    def __init__(self, base_measurement=None, child_measurement_essence_jsons=None, code=None, deprecation_info=None, description=None, dimension_analysis=None, dimension_code=None, essence=None, last_modified=None, name=None, namespace=None, parent_essence_json=None, base_measurement_essence_json=None, preferred_unit_essence_jsons=None, unit_quantity_code=None, unit_essence_jsons=None):
        """
    ...
    def base_measurement(self):
        ...
        True if the measurement is a root or base measurement, also known as dimension. False for any child measurement.
    ...
    def child_measurement_essence_jsons(self):
        ...
        The essence Json strings of any child measurement of the current measurement.
    ...
    def deprecation_info(self):
        ...
        Optional deprecation information, if the current measurement is declared as deprecated.
    ...
    def description(self):
        ...
        A description string further describing the meaning and purpose of the current measurement.
    ...
    def dimension_analysis(self):
        ...
        The dimensionality of the measurement in terms of Energistics dimension codes ()
    ...
    def dimension_code(self):
        ...
        The OSDD dimension code in case of 'SLB' or the dimension for namespace 'Energistics_UoM'.
    ...
    def essence(self):
        ...
        The essential parameterization of the measurement.
    ...
    def last_modified(self):
        ...
        The date this measurement was last updated in the format YYYYMMDD.
    ...
    def namespace(self):
        ...
        The namespace in which the current code is unique; typical values are 'SLB', 'Energistics_UoM'
    ...
    def parent_essence_json(self):
        ...
        Only populated for child measurements - the parent measurement as essence Json string.
    ...
    def base_measurement_essence_json(self):
        ...
        The base measurement as essence Json string; base measurements return themselves as persistable reference string.
    ...
    def preferred_unit_essence_jsons(self):
        ...
        If populated, the list of preferred units associated with the current measurement.
    ...
    def unit_quantity_code(self):
        ...
        The OSDD UnitQuantity code associated with this measurement - only meaningful for namespace 'SLB'.
    ...
    def unit_essence_jsons(self):
        ...
        Only populated for base measurements/dimensions: the units associated with this base measurement/dimension.
