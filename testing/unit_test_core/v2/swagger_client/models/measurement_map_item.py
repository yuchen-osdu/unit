...
class MeasurementMapItem(object):
    ...
    def __init__(self, from_measurement=None, note=None, state=None, to_measurement=None):
        """
    ...
    def from_measurement(self):
        ...
        The 'from' measurement of a measurement-to-measurement mapping.
    ...
    def to_measurement(self):
        ...
        The 'to' measurement of a measurement-to-measurement mapping.
