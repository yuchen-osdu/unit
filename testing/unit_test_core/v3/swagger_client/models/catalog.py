...
class Catalog(object):
    ...
    swagger_types = {
        ...
        'unit_system_infos': 'list[UnitSystemInfo]',
        'units': 'list[Unit]'
    }
    ...
    def __init__(self, last_modified=None, map_states=None, measurement_maps=None, measurements=None, total_map_state_count=None, total_measurement_count=None, total_measurement_map_count=None, total_unit_count=None, total_unit_map_count=None, total_unit_system_count=None, unit_maps=None, unit_system_infos=None, units=None):
        """
